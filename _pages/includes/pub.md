...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">MICCAI 2026, Top 9%</div><img src='images/RAZA_mobe.png' alt="sym" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
[Can Experts Adapt Without Training? On Test-Time Modality Generalization in MVLMs](https://arxiv.org/pdf/2607.16726) \\
  <b>Raza Imam</b><sup>#</sup>, Darakshan Rashid, Yutong Xie, Dwarikanath Mahapatra, Brejesh Lall, Mohammad Yaqub.
  (MICCAI 2026) <a href="https://github.com/BioMedIA-MBZUAI/MoBE-A-Test-Time-Modality-Generalization-Method">code</a>

- <font color="red">TLDR;</font> We introduce MoBE, an optimization-free test-time modality generalization framework for medical vision-language models that combines entropy-guided dynamic expert routing with expert-wise Bayesian adaptation to improve robustness across seen, unseen, and heterogeneous medical benchmarks without gradient updates.
</div>
</div>
